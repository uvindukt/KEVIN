...
/**
 * Servlet implementation class AllowRefundServlet
 */
@WebServlet("/AllowRefundServlet")
public class AllowRefundServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (RefundService.getRefund(id).getStatus() == Refund.ACCEPTED) {
			...
			request.setAttribute("result", RefundService.allowRefund(id));
